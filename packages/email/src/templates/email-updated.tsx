...
export default function EmailUpdated({
  oldEmail = "oldemail@dugble.com",
  newEmail = "newemail@dugle.com",
}: {
  oldEmail: string;
  newEmail: string;
}) {
